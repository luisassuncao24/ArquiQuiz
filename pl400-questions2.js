var pl400Questions2 = [
  {
    ...
    choices: [
      ...
      'Email -> Direct Email (without Exchange)',
      'Document storage -> SharePoint File Manager',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Relationship behavior type -> Parental',
      'Behavior for the assigned action -> Cascade All',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Table ownership for the class record table -> Organization',
      'Relationship of the class history table to the student table -> Many-to-many',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'Delete associated referential records -> Referential',
      'Assign active related records to new owner -> Parental',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'Calculate the efficiency of the delivery -> DIFFINDAYS(Created On, Delivery Time)',
      'Select the data type for delivery -> Date and Time',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Fitness program -> Activity table with User or Team ownership',
      'Exercise -> Standard table with Organization ownership',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Store information about doctors -> Virtual',
      'Store information about prescription medications -> Standard',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Modify knowing Id and Value1 -> Patch',
      'Delete knowing Value1 -> Remove',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'A canvas app in the first solution is published with outdated connectors.',
      'The code uses the following rule: web-avoid-blank-target.',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      'Navigate to Connections and add a new connection.',
      'Gallery1',
      'Navigate to Settings and regenerate the shared access key.',
      'Gallery2',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Artist canvas app has errors -> Monitor',
      'Application runs slowly -> Power Apps Checker',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Unexpected column value -> OnLoad',
      'Error when saving -> OnChange',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'The app runs slowly when it runs in Microsoft Teams. -> Reduce the number of connectors in the app',
      'Test users cannot add the personal app within Microsoft Teams. -> Publish the app to the Teams app store',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Outer function -> Filter',
      'Inner function -> LookUp',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'first blank -> getFormFactor',
      'second blank -> getClient',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'Plug-in deployment -> Server',
      'Plug-in step event -> PreOperation',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Uniqueness -> A. The combination of Account Number and Account Name can have duplicates',
      'Add another field -> B. Add the field to AlternateKey1 directly in the key editor',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      "Doctor's name field on customer record -> Text",
      'Auto-populate Refill date field -> Date Only',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'Code set 1 -> Add the following code at line CS101: request.UseDefaultCredentials = true;',
      'Code set 2 -> Modify code at line CS204 to select only required columns',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'outbound text -> condition',
      'nine customers in the store -> action',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'Mailing list opt-in/opt-out -> Toggle button',
      'Number of store visits -> Pie chart',
    ],
    correct: [0, 1, 2],
