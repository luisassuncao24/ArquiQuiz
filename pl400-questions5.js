var pl400Questions5 = [
  {
    ...
    choices: [
      ...
      'Match temporary workers to assignments -> Use a Virtual table',
      'Track worker availability -> Use a Business Rule',
    ],
    correct: [0, 1, 2, 3, 4],
  ...
  },
  {
    ...
    choices: [
      ...
      'Share orders between canvas apps -> Export as unmanaged solution',
      'Deploy to production -> Import as unmanaged solution',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      '1 -> A. Out-of-the-box',
      '2 -> C. Power Automate',
      'Customize financial reports -> Use Report Builder with SSRS',
      'Integrate with external payroll -> Use the Data Management workspace',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Validate data on import -> Use a real-time workflow',
      'Run server-side calculation on save -> Use a calculated column',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Impersonate calling user -> Set ImpersonatingUserId to SystemUserId',
      'Run as system user -> Use the OrganizationService in sandbox mode',
    ],
    correct: [0, 1, 2, 3],
  ...
  },
  {
    ...
    choices: [
      ...
      'Step 1 -> Create a new canvas app for technicians',
      'Step 2 -> Publish the canvas app to the production environment',
    ],
    correct: [0, 1, 2, 3, 4],
  ...
  },
  {
    ...
    choices: [
      '`start npm start`',
      '`npm start watch`',
      'Deploy to environment -> pac pcf init',
      'Test locally -> pac solution import',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Users cannot see filtered records -> Check field-level security configuration',
      'View shows wrong records -> Update the view filter criteria',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Automate recurring tasks -> Use a real-time workflow',
      'Guide users through multi-stage process -> Use a canvas app',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Requirement A -> Power Automate cloud flow',
      'Requirement B -> Business rule',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'Value -> UserLcid',
      "getFormContext().data.save() -> Saves the form programmatically",
      'Xrm.Utility.openEntityForm() -> Opens a new record form',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'usage -> bound',
      'Validate email format -> Use a Business Rule',
      'Auto-populate application number -> Use a Power Automate cloud flow',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'Store geospatial coordinates -> Use a Text column with JSON format',
      'Display survey area on a map -> Use a Power BI dashboard component',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Box 1 = formContext.getAttribute',
      'Box 2 = formContext.getControl',
    ],
    correct: [0, 1, 2, 3],
  ...
  },
  {
    ...
    choices: [
      ...
      'Authentication -> Use shared access token',
      'Action trigger -> Create a new topic in Slack',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'Push data to external -> Use Dataverse real-time workflow',
      'Pull data from external -> Use scheduled Power Automate cloud flow with HTTP action',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'Box 1 = OrganizationRequest',
      'Box 2 = EntityReference',
    ],
    correct: [0, 1, 2, 3],
  ...
  },
  {
    ...
    choices: [
      ...
      'Bing Maps -> API key',
      'Trigger flow from canvas app -> Use Power Apps trigger with return data',
      'Run flow on schedule -> Use Recurrence trigger',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Define API schema -> Use Swagger 3.0 (OpenAPI) format',
      'Test connector -> Export as managed solution and deploy',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Show notification when field changes -> Use a real-time workflow',
      'Validate record data on save -> Use a canvas app formula',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Register a webhook for the app in the Plug-in Registration Tool',
      'Register a step in the webhook',
      'Step 1 -> Register a new plug-in assembly',
      'Step 2 -> Export the plug-in as part of a solution',
    ],
    correct: [0, 1, 2, 3, 4],
  ...
  },
  {
    ...
    choices: [
      ...
      'Track program status -> Use a Business Process Flow',
      'Notify stakeholders on update -> Use an asynchronous plug-in',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Schedule data sync -> Use an Azure Timer Function with client credentials',
      'Process Dataverse events -> Use a Power Automate cloud flow with Dataverse trigger',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Box 1 = OrganizationServiceProxy',
      'Box 2 = FetchExpression',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Process refund requests -> Use a synchronous plug-in on Delete',
      'Notify warehouse on new order -> Use a canvas app push notification',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Sync pharmacy names -> Use a scheduled cloud flow with Dataverse list rows',
      'Ensure data priority -> Use a real-time workflow on Update',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Trigger background check -> Use a real-time workflow on Create',
      'Store check result -> Use a Calculated column',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Action A -> Reset the environment and re-import all solutions',
      'Action B -> Create a new developer environment and migrate',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Authentication -> Use API key in request body',
      'Action -> Use a polling trigger with 5-minute interval',
    ],
    correct: [0, 1],
