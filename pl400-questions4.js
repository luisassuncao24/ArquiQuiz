var pl400Questions4 = [
  ...
  },
  {
    ...
    choices: [
      ...
      '2 -> Custom connector',
      '3 -> Virtual entity',
      'Low latency real-time sync -> Azure Service Bus',
      'One-way data push to external -> Logic Apps',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      '3 -> Power Automate',
      'Retrieve account data in a topic -> Use list rows action with Account table',
      'Send email from a topic -> Use an HTTP request action',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'Display related records in a list -> Add a sub-grid using the form designer',
      'Run server-side logic when saving -> Register a pre-validation plug-in step',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Build the package',
      'Export solution from dev as unmanaged -> Import to test as managed',
      'Reset production environment -> Import fresh managed solution',
    ],
    correct: [0, 1, 2, 3],
  ...
  },
  {
    ...
    choices: [
      ...
      'View records -> Assign the Sales role to the team',
      'Edit records -> Grant read access via sharing',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'Connector returns error -> Check Power Automate flow logs',
      'App loads slowly on first run -> Disable the preload app setting',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Canvas app -> Export as part of an unmanaged solution',
      'Cloud flow -> Export only the flow as a ZIP file',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'Assign the test users the app security role.',
      'Add all users in the department to the TestSG security group.',
      'Track vendor invoices -> Use Power Automate to create invoice records',
      'Approve purchase orders -> Use a Business Rule to set approval status',
    ],
    correct: [0, 1, 2, 3],
  ...
  },
  {
    ...
    choices: [
      ...
      'Display Rule',
      'Enable Rule',
      'Validate date format -> Use a Power Automate cloud flow',
      'Show validation error -> Use a Business Rule to show notification',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'HideCustomAction -> Hides the button when a condition is false',
      'EnableRule -> Shows the button only for System Administrators',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Retrieve related contacts -> Use fetchXML with linked-entity filter',
      'Display opportunity pipeline -> Use a pie chart component',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Get active stage -> formContext.data.process.getActiveStageName()',
      'Move to next stage -> formContext.data.process.moveNext()',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Show/hide a field based on value -> Business Rule',
      'Validate on save with custom error -> Power Automate flow',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'PATCH /api/data/v9.2/accounts(<guid>) with If-Match: * header',
      'PUT /api/data/v9.2/accounts(<guid>) to replace all fields',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Retrieve all accounts -> GET /api/data/v9.2/accounts?$top=5000',
      'Delete a contact -> POST /api/data/v9.2/contacts(<id>)/Delete',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Japan = 0 0 19 * * 0-4',
      'Authenticate with delegated permissions -> Use client secret authentication',
      'Access Dataverse from Azure Function -> Use connection string authentication',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Read records -> Implement HTTP GET with OData filter',
      'Update records -> Implement HTTP POST to EntityDefinitions',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Trigger the flow manually -> Use Power Apps trigger',
      'Return data to the form -> Use a response action before the flow ends',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Pass record ID via URL -> Use extraqs parameter with etn= syntax',
      'Pre-populate field value via URL -> Use the recordid querystring parameter',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Azure Event Hub',
      'Azure Service Bus',
      'Sync Dataverse with Azure Blob Storage -> Use Dataverse connector in Logic Apps',
      'Send notification emails from Dataverse -> Use a synchronous plug-in',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'Display related contacts in gallery -> Use a collection variable',
      'Allow editing related records inline -> Use an editable grid',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'Register step on Create message -> Use PostOperation sync stage',
      'Throw exception to cancel operation -> Use InvalidPluginExecutionException in PreValidation',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'Connect to SharePoint lists -> Use a premium connector',
      'Send email from Power Apps -> Use Office 365 Users connector',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'Automate approval workflow -> Business rule',
      'Send notification email on record creation -> Workflow',
    ],
    correct: [0, 1, 2],
  ...
  },
  {
    ...
    choices: [
      ...
      'Add &ribbondebug=true to the URL',
      'Add &forceUCI=1 to navigate to classic UI',
    ],
    correct: [0, 1],
  ...
  },
  {
    ...
    choices: [
      ...
      'Replace fetchxml attribute with webapi="true"',
      'Add cache="true" attribute to the liquid tag',
    ],
    correct: [0, 1],
